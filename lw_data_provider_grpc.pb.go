...
type DataProviderClient interface {
	...
	GetEvent(ctx context.Context, in *th2_grpc_common_go.EventID, opts ...grpc.CallOption) (*EventResponse, error)
	// returns a single message with the specified id
	GetMessage(ctx context.Context, in *th2_grpc_common_go.MessageID, opts ...grpc.CallOption) (*MessageGroupResponse, error)
...
func (c *dataProviderClient) GetEvent(ctx context.Context, in *th2_grpc_common_go.EventID, opts ...grpc.CallOption) (*EventResponse, error) {
...
func (c *dataProviderClient) GetMessage(ctx context.Context, in *th2_grpc_common_go.MessageID, opts ...grpc.CallOption) (*MessageGroupResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type DataProviderServer interface {
	// returns a single event with the specified id
	GetEvent(context.Context, *th2_grpc_common_go.EventID) (*EventResponse, error)
	// returns a single message with the specified id
	GetMessage(context.Context, *th2_grpc_common_go.MessageID) (*MessageGroupResponse, error)
	// returns a list of message stream names
...
func (UnimplementedDataProviderServer) GetEvent(context.Context, *th2_grpc_common_go.EventID) (*EventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetEvent not implemented")
}
func (UnimplementedDataProviderServer) GetMessage(context.Context, *th2_grpc_common_go.MessageID) (*MessageGroupResponse, error) {
...
func _DataProvider_GetEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(th2_grpc_common_go.EventID)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataProviderServer).GetEvent(ctx, req.(*th2_grpc_common_go.EventID))
	}
...
func _DataProvider_GetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(th2_grpc_common_go.MessageID)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataProviderServer).GetMessage(ctx, req.(*th2_grpc_common_go.MessageID))
	}
	return interceptor(ctx, in, info, handler)
}
